...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-hub': { kind: 'none', reason: 'Browser-side command-pane overlay; aggregates existing session-list mirrors and the read-only skills.list RPC without registering any model-facing behavior.' },
  ...
  'packages/client/ui-voice': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
