...
/**
 * No runtime invariant: the mic button is a slot effect whose declaration,
 * registration, and teardown are exercised by this package, and speech
 * recognition is delegated entirely to the browser Web Speech API.
 */
